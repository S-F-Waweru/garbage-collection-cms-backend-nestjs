...
import { IncrementBalanceDto, ClientCreditResponseDto } from "../dto/client-credit.dto";
...
export class IncrementBalanceUseCase {
    ...
    async execute(dto: IncrementBalanceDto): Promise<ClientCreditResponseDto> {
        const credit = await this.creditRepository.incrementBalance(dto.clientId, dto.amount);
