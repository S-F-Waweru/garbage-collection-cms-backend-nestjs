...
// DIRECTOR, ADMIN - same as Accountant
roles.grant(Role.DIRECTOR).extend(Role.ACCOUNTANT);
roles.grant(Role.ADMIN).extend(Role.ACCOUNTANT);

// DEACTIVATED_USER - read-only own profile
roles.grant(Role.DEACTIVATED_USER).readOwn('user');
